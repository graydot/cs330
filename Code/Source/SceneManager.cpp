...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"textures/pencil_full.jpg",
		"pencil_full");

	bReturn = CreateGLTexture(
		"textures/pencil_tip.jpg",
		"pencil_tip");
...
void SceneManager::DefineObjectMaterials()
{
	...
	darkBreadMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
...
void SceneManager::DrawPencil() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 1.0f, 0.0f);
	...
	// SetShaderColor(0.2, 0.1, 0.1, 1);
	SetShaderTexture("pencil_full");
	SetShaderMaterial("wood");
	// draw the mesh with transformation values
...
void SceneManager::DrawCup() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 2.0f, 0.0f);
	...
	SetShaderColor(0.95f, 0.9f, 0.85f, 1.0f);
	// draw the mesh with transformation values
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.75f, 3.25f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 2.01f, 0.0f);
...
void SceneManager::DrawNoteBook() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(7.0f, 1.05f, 3.0f);
